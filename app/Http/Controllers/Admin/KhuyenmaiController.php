...
class KhuyenmaiController extends Controller
{
    public function getList()
    {
        ...
        foreach ($data1 as  $item) {
            ...
            $ngaybd =  date("Y-m-d", strtotime("$item->khuyenmai_time_start")); // Năm/Tháng/Ngày
    ...
    public function postAdd(KhuyenmaiAddRequest $request)
    {
        ...
        $request->file('fImage')->move(
            base_path() . '/resources/upload/khuyenmai/',
            $filename
        );
        ...
        $khuyenmai->khuyenmai_time_start = $request->txtKMTimeStart;
        ...
        if (!empty($fImage)) {
            ...
            DB::table('khuyenmai')->where('id', $id)
                ->update([
                    ...
                    'khuyenmai_time_start' => $request->txtKMTimeStart,
