...
@section('content')
<form action="{!! route('admin.khuyenmai.postAdd') !!}" method="POST" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="datetime-local" name="txtKMTimeStart" placeholder="" />
                    <div>
