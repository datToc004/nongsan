...
@section('content')
<form action="{!! route('admin.khuyenmai.postEdit',$khuyenmai->id) !!}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input class="form-control" type="datetime-local" name="txtKMTimeStart" value="{{ date('Y-m-d\TH:i', strtotime($khuyenmai->khuyenmai_time_start)) }}" placeholder="" />
                    <div>
                        {!! $errors->first('txtKMTimeStart') !!}
                    </div>
                </div>
            </div>
        <div class="col-lg-12">
