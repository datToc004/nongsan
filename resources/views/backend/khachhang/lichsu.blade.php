                                        ...
                                        <?php $count = 0; ?>
                                            @foreach ($item->chitietdh as $val)
                                                <tr>
                                                    ...
                                                    <td>
                                                    {!! number_format($val->chitietdonhang_don_gia,0,",",".") !!} vnđ 
                                                    </td>
                                                    <td>{!! $val->chitietdonhang_so_luong !!}</td>
                                                    <td>{!! number_format($val->chitietdonhang_don_gia*$val->chitietdonhang_so_luong,0,",",".") !!} vnđ </td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                            <td colspan="5">
                                            <b>Tổng tiền : {!! number_format($item->donhang_don_gia,0,",",".") !!} vnđ </b>
                                            </td>
                                            </tr>
                                        </tbody>
                                    </table>
