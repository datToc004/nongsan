...
@section('content')
<form action="{!! route('admin.sanpham.postAdd') !!}" method="POST"  enctype="multipart/form-data">
    ...
    <div class="panel-body">
        <div class="col-lg-7">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <label>Giá</label>
                    <input type="number" class="form-control" name="txtPrice" value="{!! old('txtSPSignt') !!}" placeholder="Giá..." />
                    <div>
                        {!! $errors->first('txtSPSignt') !!}
                    </div>
                </div>
