...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="{{ url('backend/bower_components/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet"
        type="text/css">

    <!-- DataTables CSS -->
    <link
        href="{{ url('backend/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css') }}"
        rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="{{ url('backend/bower_components/datatables-responsive/css/dataTables.responsive.css') }}"
        rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{!! URL('admin/bang-dieu-khien') !!}">Nông sản</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('admin.loaisanpham.list') }}">Loại sản phẩm</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.nhom.list') }}">Nhóm thực phẩm</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('admin.lohang.getNhaphang1') }}">Nhập hàng</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.khachhang.list') }}"><i class="fa fa-users"></i>Khách hàng</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.donhang.list') }}"><i class="fa fa-file-text"></i>Đơn đặt
                                hàng</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.lohang.list') }}"><i class="fa fa-file-text"></i>Đơn hàng nhập
                                hàng</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin.tuyendung.list') }}"><i class="fa fa-tags"></i>Tuyển dụng</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.khuyenmai.list') }}"><i class="fa fa-bars"></i>Khuyến mãi</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.thongke.list') }}"><i class="fa fa-cubes"></i>Thống kê</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.thongke.doanhthu') }}"><i class="fa fa-cubes"></i>Thống kê bán hàng</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.thongke.nhaphang1') }}"><i class="fa fa-cubes"></i>Thống kê nhập hàng</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
    ...
    <script
        src="{{ url('backend/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js') }}">
    </script>

    <!-- My JavaScript -->
    <script src="{{ url('backend/js/myscript.js') }}"></script>

    @yield('script_nhaphang')
    @yield('script_doanhthu')
    @yield('script_tknhaphang')
</body>
