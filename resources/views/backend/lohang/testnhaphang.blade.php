...
@section('content')
    <form action="{!! route('admin.lohang.postNhaphang1') !!}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel-heading" style="height:60px;">
                        <h3>
                            <a href="{!! URL::route('admin.khuyenmai.list') !!}" style="color:blue;"><i class="fa fa-product-hunt"
                                    style="color:blue;">Đơn hàng nhập</i></a>
                            /Thêm mới
                        </h3>
                                        ...
                                        <table class="table table-striped table-bordered table-hover"
                                            ...
                                            <tbody>
                                                @foreach ($data as $item)
                                                    <tr>
                                                        <td>
                                                            <input class="checked" onClick="add(this)" type="checkbox"
